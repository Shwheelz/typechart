...
public final class Types {
    ...
    static {
        ...
        types.put("grass",
                "Grass type Pokemon are weak against fire, flying, poison, ice, and bug moves. " +
                        "Grass type moves are good against water, rock, and ground Pokemon. " +
                        "Grass type moves are weak against grass, flying, fire, poison, bug, dragon, and steel Pokemon.");
        types.put("fire",
                "Fire type Pokemon are weak against water, ground, and rock moves. " +
                        "Fire type moves are good against grass, bug, steel, and ice Pokemon. " +
        ...
        types.put("fighting",
                "Fighting type Pokemon are weak against flying, fairy, and psychic moves. " +
                        "Fighting type moves are good against normal, rock, steel, ice, and dark Pokemon. " +
        ...
        types.put("ghost",
                "Ghost type Pokemon are weak against ghost and dark type moves, and they are immune " +
                        ...
                        "Ghost type moves are weak against dark Pokemon, and they do not " +
        ...
        types.put("psychic",
                "Psychic type Pokemon are weak against dark, ghost, and bug type moves. " +
                        ...
                        "effect dark Pokemon.");
        types.put("bug",
                "Bug type Pokemon are weak against fire, flying, and rock type moves. " +
        ...
        types.put("poison",
                "Poison type Pokemon are weak against psychic and ground type moves. " +
                        ...
                        "Poison type moves are weak against poison, rock, ground, and ghost Pokemon, and they do not " +
        ...
        types.put("electric",
                "Electric Pokemon are weak against ground moves. " +
                        ...
                        "Electric type moves are weak against electric, grass and dragon type Pokemon, and they do not " +
                        "effect ground Pokemon.");
        types.put("ice",
                "Ice type Pokemon are weak against fire, fighting, rock, and steel moves. " +
        ...
        types.put("flying",
                "Flying type Pokemon are weak against electric, rock, and ice type moves, and they are " +
                        ...
                        "Flying type moves are good against fighting, grass and bug Pokemon. " +
        ...
        types.put("ground",
                "Ground type Pokemon are weak to grass, water, and ice moves, and they are immune to " +
                        ...
                        "Ground type moves are weak against grass and bug Pokemon, and they do not effect " +
                        "flying Pokemon.");
        types.put("rock",
                "Rock type Pokemon are weak against water, ground, fighting, steel, and grass moves. " +
        ...
        types.put("steel",
                "Steel type Pokemon are weak against fighting, ground, and fire moves, and they are immune " +
                        "to poison type moves. " +
                        "Steel type moves are good against ice, rock, and fairy Pokemon. " +
                        "Steel type moves are weak against steel, water, electric, and fire Pokemon.");
        types.put("fairy",
                "Fairy type Pokemon are weak against steel and poison type moves, and they are immune " +
                        "to dragon type moves. " +
                        "Fairy type moves are good against dragon, dark, and fighting Pokemon. " +
